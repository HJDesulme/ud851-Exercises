...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int menuItemThatWasSelectedId = item.getItemId(); //Gets the id of the item selected, sets it to variable
        if (menuItemThatWasSelectedId == R.id.action_search) { //Checks if selected item id *is* menu item id
            Context context =  MainActivity.this;
            String message = "Search tapped";
